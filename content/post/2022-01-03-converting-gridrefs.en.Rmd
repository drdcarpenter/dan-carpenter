...
Now we have a wkt representation of out points, we can convert this into a simple features dataset.  The {sf} package has a function to convert data into simpel features and we can use the wkt to create the points, as follows:
